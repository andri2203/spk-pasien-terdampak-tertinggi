...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
    <div class="px-6 py-3 bg-white">
        <a href="/penyakit/tambah" class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center me-2 shadow-md">
    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50">
                ...
                <td class="px-6 py-4">
                    <a href="/penyakit/edit/{{ $data['id'] }}" class="font-medium text-blue-600 hover:underline me-2">Edit</a>
                    ...
                    <form action="/penyakit/hapus/{{ $data['id'] }}" method="post" id="popup-modal-{{ $data['id'] }}" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                        @csrf
